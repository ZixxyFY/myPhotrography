...
class Dashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: 'overview' // Options: 'overview', 'bookings', 'rentals'
    };
  }
  ...
  render() {
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-sm btn-link text-decoration-none" onClick={() => this.switchTab('bookings')}>View All</button>
              </div>
          ...
          <div className="col-lg-6">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <button className="btn btn-sm btn-link text-decoration-none" onClick={() => this.switchTab('rentals')}>Manage Inventory</button>
              </div>
              <div className="card-body p-0">
                <div className="list-group list-group-flush">
    ...
    return (
      <div className="d-flex min-vh-100 bg-light">
        ...
        {/* === LEFT SIDEBAR === */}
        {/* FIX: Use 'flex-column' (Bootstrap) instead of 'flex-col' (Tailwind) */}
        <div className="bg-dark text-white d-flex flex-column flex-shrink-0 p-3" style={{width: '260px', height: '100vh', position: 'sticky', top: 0}}>
          ...
          <div className="mb-4 px-2 d-flex align-items-center">
            ...
            <h5 className="fw-bold mb-0">E-Imagination <span className="badge bg-secondary ms-1" style={{fontSize: '0.5em', verticalAlign: 'middle'}}>ADMIN</span></h5>
          </div>
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            <li className="nav-item mb-1">
              <button 
                onClick={() => this.switchTab('bookings')}
            ...
            <li className="nav-item mb-1">
              <button 
                onClick={() => this.switchTab('rentals')}
